...
public class BatBien extends AppCompatActivity {
    ImageView logo, addBatBien, menuDanhMuc;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.khach_tro:
                        ...
                        return true;
                    case R.id.dat_coc:
                        Intent datCoc = new Intent(BatBien.this, TienCocAdd.class);
                    ...
                    case R.id.thay_cong_to_nuoc:
                        Intent thay_cong_to_nuoc = new Intent(BatBien.this, CongToNuoc.class);
                        startActivity(thay_cong_to_nuoc);
                        return true;
                    case R.id.thay_cong_to_dien:
                        Intent thay_cong_to_dien = new Intent(BatBien.this, CongToDien.class);
                        startActivity(thay_cong_to_dien);
                        return true;
                    case R.id.doi_thiet_bi:
                        Intent doi_thiet_bi = new Intent(BatBien.this, DoiThietBi.class);
